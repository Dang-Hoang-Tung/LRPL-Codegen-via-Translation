...
class Day04Test {
    ...
    fun `Part 1 solution works for sample data`() {
        assertThat(Day04(day04_sample.lines()).part1()).isEqualTo(240)
    }

    @Tag("Solution")
    @Test()
    fun `Part 1 solution`() {
        assertThat(Day04(day04.lines()).part1()).isEqualTo(30630)
    }

    @Test
    fun `Part 2 solution works for sample data`() {
        assertThat(Day04(day04_sample.lines()).part2()).isEqualTo(4455)
    }

    @Tag("Solution")
    @Test()
    fun `Part 2 solution`() {
        assertThat(Day04(day04.lines()).part2()).isEqualTo(136571)
    }
}